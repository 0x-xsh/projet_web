...
ALLOWED_HOSTS = ['*', 'localhost', '127.0.0.1', 'users_service', 'users_service:8000', 'users-service', 'users-service:8000', 'projet_web-users_service-1', 'projet_web-users_service-1:8000']  # Added hosts with port numbers
